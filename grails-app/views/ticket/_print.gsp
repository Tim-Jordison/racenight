...
<div class="print-section">
    ...
    <img class="print-logo" src="/images/custom/triple_crown_racing_logo_741x101.png"/>
    <div class="centered">
        Event: ${event.name}<br/>
    ...
    <table class="printable-table">
        ...
        <tr>
            <td>Total</td>
            <td>${bets*.numberOfBets.sum()} @ <racenight:displayDollarsAndCentsFromCents cents="${event.betPriceInCents}"/> each</td>
